-- 智慧煤矿ERP管理系统 - 中文示例数据（安全版本）
-- 此版本不包含字段添加逻辑，假设表结构已完整
...
ON DUPLICATE KEY UPDATE fault_description=VALUES(fault_description);
...
ON DUPLICATE KEY UPDATE alert_title=VALUES(alert_title);

-- ============================================
-- 7. 财务模块 - 客户数据
-- ============================================
-- 注意：如果表中有contact_person和credit_level字段，则使用完整字段列表
-- 如果没有，请先执行修复脚本添加字段，或使用简化版本
...
-- 8. 财务模块 - 供应商数据
-- ============================================
-- 注意：如果表中有contact_person和evaluation_level字段，则使用完整字段列表
