-- Active: 1763309353763@@127.0.0.1@3306@coal_erp
-- 财务模块数据库表结构
...
CREATE TABLE IF NOT EXISTS account_subject (
  ...
  is_leaf char(1) DEFAULT '1' COMMENT '是否末级科目',
...
CREATE TABLE IF NOT EXISTS voucher_detail (
  ...
  staff_id bigint(20) DEFAULT NULL COMMENT '人员ID',
...
CREATE TABLE IF NOT EXISTS account_balance (
  ...
  subject_name varchar(100) DEFAULT NULL COMMENT '科目名称',
  period varchar(6) NOT NULL COMMENT '会计期间',
  begin_direction varchar(10) DEFAULT NULL COMMENT '期初余额方向',
  ...
  end_direction varchar(10) DEFAULT NULL COMMENT '期末余额方向',
